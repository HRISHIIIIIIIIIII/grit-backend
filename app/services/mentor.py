...
_LIBRARY: dict[tuple[str, MentorTone], list[_Variant]] = {
    (EVENT_STREAK_PROTECTION, MentorTone.GENTLE): [
        _Variant("Your streak is waiting", "A {streak}-day streak is still alive. A few minutes now keeps it glowing."),
        _Variant("One small step", "You've come {streak} days. Tonight's check-in is all it takes to carry it forward."),
    ],
    (EVENT_STREAK_PROTECTION, MentorTone.HARD): [
        _Variant("Don't drop it now", "{streak} days of work is on the line tonight. Close the loop before midnight."),
        _Variant("Protect the streak", "You didn't build {streak} days to lose them to one lazy evening. Check in."),
    ],
    (EVENT_STREAK_PROTECTION, MentorTone.RELENTLESS): [
        _Variant("No excuses", "{streak} days. Zero reasons to break it. Move."),
        _Variant("Finish the day", "The streak doesn't care that you're tired. {streak} days say show up. Now."),
    ],
    (EVENT_ACCOUNTABILITY, MentorTone.GENTLE): [
        _Variant("Yesterday slipped", "No guilt — yesterday is gone. Today is open. Start with one habit."),
    ],
    ...
    (EVENT_REENGAGEMENT, MentorTone.GENTLE): [
        _Variant("We saved your spot", "It's been a little while. Your habits are right where you left them whenever you're ready."),
    ],
    (EVENT_REENGAGEMENT, MentorTone.HARD): [
        _Variant("Time to return", "A few days off becomes a few weeks fast. Come back and reset the clock today."),
    ],
    (EVENT_REENGAGEMENT, MentorTone.RELENTLESS): [
        _Variant("Stop drifting", "Momentum is rotting while you wait. One check-in restarts the engine. Do it."),
    ],
    (EVENT_REVIEW_WEEKLY, MentorTone.GENTLE): [
        _Variant("Your week in review", "You logged {checkins} check-ins this week. Quiet, steady progress counts."),
    ],
    (EVENT_REVIEW_WEEKLY, MentorTone.HARD): [
        _Variant("Weekly scoreboard", "{checkins} check-ins this week. Look at the number, then beat it next week."),
    ],
    (EVENT_REVIEW_WEEKLY, MentorTone.RELENTLESS): [
        _Variant("Week closed", "{checkins} check-ins. Good. Now raise the floor — next week starts harder."),
    ],
    (EVENT_REVIEW_MONTHLY, MentorTone.GENTLE): [
        _Variant("A month of you", "This month you showed up {checkins} times. That's who you're becoming."),
    ],
    (EVENT_REVIEW_MONTHLY, MentorTone.HARD): [
        _Variant("Monthly tally", "{checkins} check-ins this month. Discipline is a number now. Grow it."),
    ],
    (EVENT_REVIEW_MONTHLY, MentorTone.RELENTLESS): [
        _Variant("Month logged", "{checkins} this month. The identity is forming. Don't soften now."),
    ],
    ...
    (EVENT_ACHIEVEMENT, MentorTone.GENTLE): [
        _Variant("Achievement unlocked", "You earned \"{achievement}\". A real sign of your consistency."),
    ],
    (EVENT_ACHIEVEMENT, MentorTone.HARD): [
        _Variant("Unlocked: {achievement}", "Earned, not given. \"{achievement}\" is yours. Go get the next one."),
    ],
    (EVENT_ACHIEVEMENT, MentorTone.RELENTLESS): [
        _Variant("Trophy taken", "\"{achievement}\" unlocked. Proof you can do hard things. Again tomorrow."),
    ],
...
def generate_mentor_message(
    event: str, tone: MentorTone, **context: object
) -> MentorMessage:
